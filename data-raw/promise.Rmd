...
echo <- echo %>%
        ...
        mutate(Echo.date = as.POSIXct(log_dos, format = "%m/%d/%Y %H:%M:%S", tz = "America/New_York", tz = "America/New_York"),
...
demo.df <- demo.df %>%
        transmute(MRN = Duke.MRN, 
               ...
               DOB = as.POSIXct(Patient.Date.of.Birth, 
                                format = "%m/%d/%Y %H:%M:%S", tz = "America/New_York", tz = "America/New_York"),
