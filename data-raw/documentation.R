...
#'    \item{echo_indication}{Indication for Echo exam (Text)}
...
#'    \item{Na.lab.Value}{Natrium blood mmol/L}
#'    \item{K.lab.Date}{Potassium blood Date}
#'    \item{K.lab.Value}{Potassium blood mmol/L}
#'    \item{BNP.lab.Date}{Brain natriuretic peptide Date}
#'    \item{BNP.lab.Value}{Brain natriuretic peptide}
#'    \item{ProBNP.lab.Date}{Pro - Brain natriuretic peptide Date}
#'    \item{ProBNP.lab.Value}{Pro - Brain natriuretic peptide}
