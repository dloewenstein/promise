#' The PROMISE dataset
#' 
#' A dataset containing the demographics, and matched ECG and Echo data
#' for Duke University Hospital patients between the years 2002-2017.
#' 
#' @author Daniel Loewenstein, \email{loewenstein.daniel@@gmail.com}
#' @author Karin Johansson, \email{karin.g.johansson@@gmail.com}
#' @docType data
#' @keywords dataset
...
#'    \item{PAP.mm.hg}{Echocardiographic Estimated Right ventricular systolic pressure (mmHg)}
#'    \item{echo_indication}{Indication for echo exam}
#'    \item{ECGDate}{Date of ECG exam, used in Echo ECG matching}
#'    \item{PRInterval}{PR interval (ms)}
#'    \item{QRSDur}{QRS duration (ms)}
#'    \item{QTCorrected}{QT interval corrected (Bazett's formula) (ms)}
#'    \item{AXIS}{R axis}
#'    \item{filepath}{name of raw ECG XML file}
#'    \item{Normal_conduction}{Normal conduction 1/0 = yes/no}
...
#'    \item{K.lab.Value.x}{Potassium blood mmol/L (numeric)}
#'    \item{BNP.lab.Date}{Brain natriuretic peptide Date}
#'    \item{BNP.lab.Value.x}{Brain natriuretic peptide (numeric)}
#'    \item{ProBNP.lab.Date}{Pro - Brain natriuretic peptide Date}
#'    \item{ProBNP.lab.Value.x}{Pro - Brain natriuretic peptide (numeric)}
#'    \item{GFR.lab.Date}{Glomerular filtrartion rate Date}
#'    \item{GFR.lab.Value.x}{Glomerular filtration rate (numeric)}
#' }
#'  @details
